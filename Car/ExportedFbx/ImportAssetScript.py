...
#Use this command : unreal_engine.py_exec(r"D:\Users\etudiant\Documents\GitHub\REKT_Assets\Car\ExportedFbx\ImportAssetScript.py")
...
################[ Import Frontbumper_Lower as StaticMesh type ]################
...
FbxLoc = os.path.join(r'D:\Users\etudiant\Documents\GitHub\REKT_Assets\Car\ExportedFbx\StaticMesh\SM_Frontbumper_Lower.fbx')
AdditionalParameterLoc = os.path.join(r'D:\Users\etudiant\Documents\GitHub\REKT_Assets\Car\ExportedFbx\StaticMesh\SM_Frontbumper_Lower_AdditionalParameter.ini')
...
try:
	...
	ImportedAsset.append('Import error for asset named "Frontbumper_Lower" ')
