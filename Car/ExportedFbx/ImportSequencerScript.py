...
#Use this command : unreal_engine.py_exec(r"D:\Users\etudiant\Documents\GitHub\REKT_Assets\Car\ExportedFbx\ImportSequencerScript.py")
...
if seq:
	...
	camera_cut_section.sequencer_set_section_range(1/frameRateNumerator, (100-secureCrop)/frameRateNumerator)
#Import camera cut section
if seq:
	camera_cut_section = camera_cut_track.sequencer_track_add_section()
	#Not camera found for this section
	camera_cut_section.sequencer_set_section_range(100/frameRateNumerator, (251-secureCrop)/frameRateNumerator)
